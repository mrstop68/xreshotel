...
<head>
    ...
    <title>ResClick Theme | Standart Twin Oda</title>
    ...
    <section>
        <div class="swiper mySwiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide" style="background-image:linear-gradient(to top,rgba(0,0,0,0.5),rgba(0,0,0,0)), url('images/home/14.webp'); background-position: center;background-size: cover;">
                </div>

                <span class="roomName">Standart Twin Oda</span>
            </div>
        ...
        <div class="roomdetail" data-aos="fade-up">
            <div class="detailcontent">
                ...
                <div class="sub-body detailrigt">
                    <div><img src="images/home/14.webp" alt=""></div>
                </div>
            </div>
        </div>
    </section>
