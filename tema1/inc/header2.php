            ...
            <nav>
                ...
                <div class="nav-container">
                    ...
                    if((empty($langURL))){
                        ...
                        <?php  }else if($pages->status!='false' && (!isset($pages->subpage))){?>
                                <div class="dropdown">
                  ...
                  ?>
                   <!-- <div class="dropdown">
                            <li class="nav-tab">Üst menu <img src="<?=$dataHOTEL->website?>/tema1/images/down-arrow.svg" alt=""></li>
                        <div class="dropdown-content">
                            <li class="nav-tab"><a href="#">alt menu 1</a></li>
                            <li class="nav-tab"><a href="#">alt menu 2</a></li>
                        </div>
                   </div> -->
