...
<head>
    ...
    <section>
        ...
        <div class="img-top" style="background-image:url('<?=$imagesLink?><?php if(isset($newArrayImg[$randIMG+1]->imgName)) {echo $newArrayImg[$randIMG+1]->imgName;} else if(isset($newArrayImg[$randIMG-1]->imgName)){echo $newArrayImg[$randIMG-1]->imgName;}?>') ;"></div>
