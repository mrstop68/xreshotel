...
<style>
   .swiper {
    ...
    <?php include 'inc/header.php' ?> 
        ...
        <div class="img-top" style="background-image:url('images/home/14.webp') ;"></div>
                ...
                <div class="swiper mySwiper">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <img src="images/home/12.webp" alt="<?=$seoData->imagetag?>"/>
                    </div>
                    <div class="swiper-slide">
                      <img src="images/home/13.webp" alt="<?=$seoData->imagetag?>"/>
                    </div>
                    <div class="swiper-slide">
                      <img src="images/home/14.webp" alt="<?=$seoData->imagetag?>"/>
                    </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-12 order-1 order-lg-2 text-center">
                <div class="swiper mySwiper">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <img src="images/home/11.webp" alt="<?=$seoData->imagetag?>"/>
                    </div>
                    <div class="swiper-slide">
                      <img src="images/home/12.webp" alt="<?=$seoData->imagetag?>"/>
                    </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-12 order-1 order-lg-2 text-center">
                <div class="swiper mySwiper">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <img src="images/home/7.webp" alt="<?=$seoData->imagetag?>"/>
                    </div>
                    <div class="swiper-slide">
                      <img src="images/home/8.webp" alt="<?=$seoData->imagetag?>"/>
                    </div>
                    <div class="swiper-slide">
                      <img src="images/home/9.webp" alt="<?=$seoData->imagetag?>"/>
                    </div>
                    <div class="swiper-slide">
                      <img src="images/home/10.webp" alt="<?=$seoData->imagetag?>"/>
                    </div>
                  </div>
                  <div class="swiper-pagination"></div>
                </div>
    ...
    <!-- mid-content -->
    <section id="middle-cover" style="background:linear-gradient( rgba(0, 0, 0, 0.5) 100%, rgba(0, 0, 0, 0.5)100%),url(images/home/6.webp) no-repeat fixed center center / cover rgba(0, 0, 0, 5);">
    <div class="container">
