...
<head>
    ...
    <title>ResClick Theme | Aile Odası</title>
    <meta name="description" content="ResClick" />
    <meta property="og:locale" content="tr_TR" />
    <meta property="og:url" content="https://resclick.com/" />
    <meta property="og:title" content="ResClick Theme" />
    <meta property="og:description" content="ResClick" />
    ...
    <meta name="twitter:description" content="ResClick" />
    ...
    <section>
        <div class="swiper mySwiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide" style="background-image:linear-gradient(to top,rgba(0,0,0,0.5),rgba(0,0,0,0)), url('images/home/12.webp'); background-position: center;background-size: cover;">
                </div>

                <span class="roomName">Aile Odası</span>
            </div>
            ...
            <div class="detailcontent">
                <div class="sub-body detailleft">
                    ...
                    <div class="roomProperty">
                        <div class="property"><img src="images/area.svg" alt="">Alan: 18 <span>m</span><sup>2</sup></div>
                ...
                <div class="sub-body detailrigt">
                    <div><img src="images/home/12.webp" alt=""></div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="cont">
            <div class="demo-gallery">
                <ul id="lightgallery">
                    ...
                    <li data-src="images/home/16.webp" data-sub-html="<h4></h4><p></p>">
                        <a href="">
