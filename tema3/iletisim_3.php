                    ...
                    <?php } ?>
                        ...
                        ?>
                            <?php if($seoData->adress){ ?>
                                <li><img src="<?=$dataHOTEL->website?>/tema3/images/svg/map.svg" alt="<?=$seoData->imagetag?>" width="13"><span><?=$filtergroupcontent[0]->content?> <?=$seoData->adress?></span></li>
                            <?php }?>
                        ...
                        ?>
                            <?php if($dataHOTEL->seoinfo->phone1){ ?>
                                <li><img src="<?=$dataHOTEL->website?>/tema3/images/svg/phone.svg" alt="<?=$seoData->imagetag?>" width="13"><a href="tel:<?=$dataHOTEL->seoinfo->phone1?>"><span><?=$filtergroupcontent[0]->content?> <?=$dataHOTEL->seoinfo->phone1?></span></a></li>
                        ...
                        ?>
                            <?php if($dataHOTEL->seoinfo->phone2){ ?>
                                <li><img src="<?=$dataHOTEL->website?>/tema3/images/svg/phone.svg" alt="<?=$seoData->imagetag?>" width="13"><a href="tel:<?=$dataHOTEL->seoinfo->phone2?>"><span><?=$filtergroupcontent[0]->content?> <?=$dataHOTEL->seoinfo->phone2?></span></a></li>
                        ...
                        ?>
                            <?php if($dataHOTEL->seoinfo->email){ ?>
                                <li><img src="<?=$dataHOTEL->website?>/tema3/images/svg/envelope.svg" alt="<?=$seoData->imagetag?>" width="13"><a href="mailto:<?=$dataHOTEL->seoinfo->email?>"><span><?=$filtergroupcontent[0]->content?> <?=$dataHOTEL->seoinfo->email?></span> </a></li>
